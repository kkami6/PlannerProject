    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DailyRemiderId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyRemiders", x => x.DailyRemiderId);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Recurrence = table.Column<int>(type: "int", nullable: false),
                    ActivityDiscriminator = table.Column<string>(type: "varchar(13)", maxLength: 13, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    BirthdayPerson = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDailyRemiders", x => new { x.UserId, x.DailyRemiderId });
                    table.ForeignKey(
                        name: "FK_UserDailyRemider_DailyRemider",
                        column: x => x.DailyRemiderId,
                        principalTable: "DailyRemiders",
                        principalColumn: "DailyRemiderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDailyRemiders_DailyRemiderId",
                table: "UserDailyRemiders",
                column: "DailyRemiderId");
        }
